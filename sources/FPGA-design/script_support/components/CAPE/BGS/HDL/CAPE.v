...
wire   [31:0]  apb_ctrl_prdata;
wire   [31:0]  pixel_proc_0_prdata;
wire           pixel_proc_0_irq;
...
//--------------------------------------------------------------------
// PRDATA mux: paddr[7] routes between apb_ctrl_status (0x00-0x7F) and pixel_proc (0x80-0xFF)
assign APB_SLAVE_PRDATA             = (APB_SLAVE_SLAVE_PADDR_0[7]) ? pixel_proc_0_prdata : apb_ctrl_prdata;
