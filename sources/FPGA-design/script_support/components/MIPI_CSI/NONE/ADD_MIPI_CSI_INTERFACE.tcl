...
# Instantiate terminator for FIC3 slot 2 (CSI_APB_MTARGET)
set sd_name ${top_level_name}
sd_instantiate_hdl_core -sd_name ${sd_name} -hdl_core_name {apb_terminator} -instance_name {CSI_APB_TERM}

# Clocks
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:FIC_3_PCLK" "CSI_APB_TERM:PCLK"}
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:FIC_3_FABRIC_RESET_N" "CSI_APB_TERM:PRESETN"}

# APB — connect terminator to FIC3 slot 2
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI_APB_TERM:APB_TARGET" "BVF_RISCV_SUBSYSTEM:CSI_APB_MTARGET"}
