//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Sun Jul 12 21:05:42 2026
...
wire           MMUART_2_RXD;
wire           MMUART_2_RXD_BIBUF_Y;
wire           MMUART_2_TXD;
wire           MMUART_3_RXD;
wire           MMUART_3_TXD_net_0;
wire           MMUART_4_RXD;
wire           MMUART_4_RXD_BIBUF_Y;
wire           MMUART_4_TXD;
...
wire           PF_SOC_MSS_MMUART_2_TXD_M2F;
wire           PF_SOC_MSS_MMUART_4_TXD_M2F;
wire           PF_SOC_MSS_SPI_0_CLK_M2F;
wire           PF_SOC_MSS_SPI_0_CLK_OE_M2F;
wire           PF_SOC_MSS_SPI_0_DO_M2F;
wire           PF_SOC_MSS_SPI_0_DO_OE_M2F;
wire           PF_SOC_MSS_SPI_0_SS1_M2F;
wire           PF_SOC_MSS_SPI_0_SS1_OE_M2F;
wire           PF_SOC_MSS_SPI_1_CLK_M2F;
wire           PF_SOC_MSS_SPI_1_CLK_OE_M2F;
wire           PF_SOC_MSS_SPI_1_SS1_M2F;
wire           PF_SOC_MSS_SPI_1_SS1_OE_M2F;
wire           PHY_INTn;
wire           PHY_MDC_net_0;
wire           PHY_MDIO;
wire           PRESETN;
...
wire           SPI_0_DI;
wire           SPI_0_DI_BIBUF_Y;
wire           SPI_0_DO;
wire           SPI_0_SS1;
wire           SPI_0_SS1_BIBUF_Y;
wire           SPI_1_CLK;
wire           SPI_1_CLK_BIBUF_Y;
wire           SPI_1_DI;
wire           SPI_1_DI_BIBUF_Y;
wire           SPI_1_SS1;
wire           SPI_1_SS1_BIBUF_Y;
wire           UART0_RXD;
...
//--------------------------------------------------------------------
assign MSS_INT_F2M_net_0 = { MIV_IHC_C0_0_APP_IRQ_H0 , MIV_IHC_C0_0_APP_IRQ_H1 , MIV_IHC_C0_0_APP_IRQ_H2 , MIV_IHC_C0_0_APP_IRQ_H3 , MIV_IHC_C0_0_APP_IRQ_H4 , MSS_INT_F2M , PHY_INTn , PCIE_INT , 1'b0 };
//--------------------------------------------------------------------
// Component instances
//--------------------------------------------------------------------
//--------AND4
...
MIV_IHC_C0 MIV_IHC_C0_0(
        ...
        .CORE_CLK      ( FIC_3_PCLK ),
        .CORE_RESETN   ( PRESETN ),
        .APB_0_PCLK    ( FIC_3_PCLK ),
        .APB_0_PRESETn ( PRESETN ),
        .APB_0_PADDR   ( APB_ARBITER_0_APB_MASTER_high_PADDR ),
        .APB_0_PENABLE ( APB_ARBITER_0_APB_MASTER_high_PENABLE ),
        .APB_0_PWRITE  ( APB_ARBITER_0_APB_MASTER_high_PWRITE ),
        .APB_0_PWDATA  ( APB_ARBITER_0_APB_MASTER_high_PWDATA ),
        .APB_0_PSEL    ( APB_ARBITER_0_APB_MASTER_high_PSELx ),
        // Outputs
        .APP_IRQ_H4    ( MIV_IHC_C0_0_APP_IRQ_H4 ),
        .APP_IRQ_H3    ( MIV_IHC_C0_0_APP_IRQ_H3 ),
        .APP_IRQ_H2    ( MIV_IHC_C0_0_APP_IRQ_H2 ),
        .APP_IRQ_H1    ( MIV_IHC_C0_0_APP_IRQ_H1 ),
        .APP_IRQ_H0    ( MIV_IHC_C0_0_APP_IRQ_H0 ),
        .APB_0_PRDATA  ( APB_ARBITER_0_APB_MASTER_high_PRDATA ),
        .APB_0_PREADY  ( APB_ARBITER_0_APB_MASTER_high_PREADY ),
        .APB_0_PSLVERR ( APB_ARBITER_0_APB_MASTER_high_PSLVERR ) 
        );

//--------BIBUF
BIBUF MMUART_2_RXD_BIBUF(
        // Inputs
        .D   ( GND_net ),
        .E   ( GND_net ),
        // Outputs
        .Y   ( MMUART_2_RXD_BIBUF_Y ),
        // Inouts
        .PAD ( MMUART_2_RXD ) 
        );

//--------BIBUF
BIBUF MMUART_2_TXD_BIBUF(
        // Inputs
        .D   ( PF_SOC_MSS_MMUART_2_TXD_M2F ),
        .E   ( VCC_net ),
        // Outputs
        .Y   (  ),
        // Inouts
...
//--------BIBUF
BIBUF MMUART_4_RXD_BIBUF(
        // Inputs
        .D   ( GND_net ),
        .E   ( GND_net ),
        // Outputs
        .Y   ( MMUART_4_RXD_BIBUF_Y ),
        // Inouts
        .PAD ( MMUART_4_RXD ) 
        );

//--------BIBUF
BIBUF MMUART_4_TXD_BIBUF(
        // Inputs
        .D   ( PF_SOC_MSS_MMUART_4_TXD_M2F ),
        .E   ( VCC_net ),
        // Outputs
        .Y   (  ),
        // Inouts
...
PF_SOC_MSS PF_SOC_MSS_inst_0(
        ...
        .MMUART_2_RXD_F2M     ( MMUART_2_RXD_BIBUF_Y ),
        .MMUART_3_RXD_F2M     ( MMUART_3_RXD ),
        .MMUART_4_RXD_F2M     ( MMUART_4_RXD_BIBUF_Y ),
        .CAN_0_RXBUS_F2M      ( CAN_0_RXBUS ),
        .CAN_1_RXBUS_F2M      ( CAN_1_RXBUS ),
        .SPI_0_SS_F2M         ( SPI_0_SS1_BIBUF_Y ),
        .SPI_0_DI_F2M         ( SPI_0_DI_BIBUF_Y ),
        .SPI_0_CLK_F2M        ( SPI_0_CLK_BIBUF_Y ),
        .SPI_1_SS_F2M         ( SPI_1_SS1_BIBUF_Y ),
        .SPI_1_DI_F2M         ( SPI_1_DI_BIBUF_Y ),
        .SPI_1_CLK_F2M        ( SPI_1_CLK_BIBUF_Y ),
        ...
        .MMUART_1_TXD_OE_M2F  (  ),
        .MMUART_2_TXD_M2F     ( PF_SOC_MSS_MMUART_2_TXD_M2F ),
        .MMUART_3_TXD_M2F     ( MMUART_3_TXD_net_0 ),
        .MMUART_4_TXD_M2F     ( PF_SOC_MSS_MMUART_4_TXD_M2F ),
        ...
        .SPI_0_SS1_M2F        ( PF_SOC_MSS_SPI_0_SS1_M2F ),
        .SPI_0_SS1_OE_M2F     ( PF_SOC_MSS_SPI_0_SS1_OE_M2F ),
        .SPI_1_SS1_M2F        ( PF_SOC_MSS_SPI_1_SS1_M2F ),
        .SPI_1_SS1_OE_M2F     ( PF_SOC_MSS_SPI_1_SS1_OE_M2F ),
        .SPI_0_DO_M2F         ( PF_SOC_MSS_SPI_0_DO_M2F ),
        .SPI_0_DO_OE_M2F      ( PF_SOC_MSS_SPI_0_DO_OE_M2F ),
        .SPI_0_CLK_M2F        ( PF_SOC_MSS_SPI_0_CLK_M2F ),
        .SPI_0_CLK_OE_M2F     ( PF_SOC_MSS_SPI_0_CLK_OE_M2F ),
        .SPI_1_DO_M2F         (  ),
        .SPI_1_DO_OE_M2F      (  ),
        .SPI_1_CLK_M2F        ( PF_SOC_MSS_SPI_1_CLK_M2F ),
        .SPI_1_CLK_OE_M2F     ( PF_SOC_MSS_SPI_1_CLK_OE_M2F ),
        ...
        .I2C_1_SDA            ( I2C_1_SDA ),
        .MAC_0_MDIO           ( PHY_MDIO ),
        .USB_DATA0            ( USB_DATA[0:0] ),
        .USB_DATA1            ( USB_DATA[1:1] ),
        .USB_DATA2            ( USB_DATA[2:2] ),
        .USB_DATA3            ( USB_DATA[3:3] ),
        .USB_DATA4            ( USB_DATA[4:4] ),
        .USB_DATA5            ( USB_DATA[5:5] ),
        .USB_DATA6            ( USB_DATA[6:6] ),
        .USB_DATA7            ( USB_DATA[7:7] ),
        .QSPI_DATA0           ( ADC_MOSI ),
        .QSPI_DATA1           ( ADC_MISO ),
        .EMMC_CMD             ( EMMC_CMD ),
        .EMMC_DATA0           ( EMMC_DATA[0:0] ),
        .EMMC_DATA1           ( EMMC_DATA[1:1] ),
        .EMMC_DATA2           ( EMMC_DATA[2:2] ),
        .EMMC_DATA3           ( EMMC_DATA[3:3] ),
        .EMMC_DATA4           ( EMMC_DATA[4:4] ),
        .EMMC_DATA5           ( EMMC_DATA[5:5] ),
        .EMMC_DATA6           ( EMMC_DATA[6:6] ),
        .EMMC_DATA7           ( EMMC_DATA[7:7] ),
        .DQ                   ( DQ ),
        .DQS                  ( DQS ),
        .DQS_N                ( DQS_N ) 
        );
...
BIBUF SPI_0_CLK_BIBUF(
        // Inputs
        .D   ( PF_SOC_MSS_SPI_0_CLK_M2F ),
        .E   ( PF_SOC_MSS_SPI_0_CLK_OE_M2F ),
        // Outputs
        .Y   ( SPI_0_CLK_BIBUF_Y ),
        // Inouts
        .PAD ( SPI_0_CLK ) 
...
//--------BIBUF
BIBUF SPI_0_DO_BIBUF(
        // Inputs
        .D   ( PF_SOC_MSS_SPI_0_DO_M2F ),
        .E   ( PF_SOC_MSS_SPI_0_DO_OE_M2F ),
        // Outputs
        .Y   (  ),
        // Inouts
        .PAD ( SPI_0_DO ) 
...
//--------BIBUF
BIBUF SPI_0_SS1_BIBUF(
        // Inputs
        .D   ( PF_SOC_MSS_SPI_0_SS1_M2F ),
        .E   ( PF_SOC_MSS_SPI_0_SS1_OE_M2F ),
        // Outputs
        .Y   ( SPI_0_SS1_BIBUF_Y ),
        // Inouts
        .PAD ( SPI_0_SS1 ) 
...
//--------BIBUF
BIBUF SPI_1_CLK_BIBUF(
        // Inputs
        .D   ( PF_SOC_MSS_SPI_1_CLK_M2F ),
        .E   ( PF_SOC_MSS_SPI_1_CLK_OE_M2F ),
        // Outputs
        .Y   ( SPI_1_CLK_BIBUF_Y ),
        // Inouts
        .PAD ( SPI_1_CLK ) 
...
//--------BIBUF
BIBUF SPI_1_SS1_BIBUF(
        // Inputs
        .D   ( PF_SOC_MSS_SPI_1_SS1_M2F ),
        .E   ( PF_SOC_MSS_SPI_1_SS1_OE_M2F ),
        // Outputs
        .Y   ( SPI_1_SS1_BIBUF_Y ),
        // Inouts
        .PAD ( SPI_1_SS1 ) 
