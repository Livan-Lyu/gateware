...
module caxi4interconnect_DERR_Target # 
	(
...
// Explicit width padding for devRevision (32-bit) to DATA_WIDTH
assign DERR_RDATA	= {{(DATA_WIDTH-32){1'b0}}, devRevision};	// send back caxi4interconnect_revision as read data.
...
endmodule // caxi4interconnect_DERR_Target.v
